...
public class JSON {
     ...
     */
    @NotNull
    public <T> T to(@NotNull final Class<T> clazz) throws IOException {
     ...
     */
    @NotNull
    public synchronized static JSON valueOf(@NotNull final String json) throws IOException {
     ...
     */
    @NotNull
    public synchronized static String format(@NotNull final Object obj) throws IOException {
